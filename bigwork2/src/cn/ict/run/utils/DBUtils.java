...
//    }
    ...
    public DBUtils() throws ClassNotFoundException,
        ...
        //2. 建立连接
        String url = "jdbc:mysql://127.0.0.1:3306/demo?useUnicode=true&characterEncoding=UTF8";
        String user = "root";
        String pwd = "xuemian168";
...
//        ResultSet rs = prestmt.executeQuery();//select
    ...
    public List<String[]> getaData(String[] field, String sql) {
